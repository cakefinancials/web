  ...
  render() {
    ...
    return (
      <Col xs={10} xsOffset={1}>
        <br />
        <p>
          At Cake we want you to make money from your Employee Stock without having to worry about it. In order to
          guarantee this, one of our analysts will need access to your brokerage account so that we can do the
          following:
        </p>
        <br />
        <div className="centered-text">
          ...
          <p>
            <small>
              <small>
                <i>
                  ** This is the Cake policy so that risk exposure is minimized and your gains reach you as soon as
                  possible
                </i>
              </small>
            </small>
